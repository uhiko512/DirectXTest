...
PSOutput main(PSInput i) {
	...
	float r = roughness.Sample(sampleType, puv);
	...
	float z = 1.0 - i.pos.z / i.pos.w;
	float eyeZ = (0.001f * 1000.0f) / (1000.0f - z * (1000.0f - 0.001f));

	o.color = color;//diffuse + specular + ambient;
